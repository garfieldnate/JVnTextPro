...
public class WordDataWriter extends DataWriter {
    /* (non-Javadoc)
     * @see edu.vnu.jvntext.jvntextpro.data.DataWriter#writeFile(java.util.List, java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see edu.vnu.jvntext.jvntextpro.data.DataWriter#writeString(java.util.List)
     */
    @Override
